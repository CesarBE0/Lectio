<x-layouts.layout>
    ...
    <div class="container mx-auto px-6 pt-4 pb-12 space-y-12">
        ...
        <section class="flex flex-col md:flex-row gap-6 mb-8">
            ...
            <div
                class="w-full md:w-2/3 bg-black text-white p-8 md:p-12 rounded-3xl flex flex-col justify-between border border-[#D4AF37]/20 relative overflow-hidden shadow-2xl group">
                <div class="absolute inset-0 opacity-10 group-hover:opacity-15 transition-opacity"
                     style="background-image: url('data:image/svg+xml,%3Csvg width=%2252%22 height=%2226%22 viewBox=%220 0 52 26%22 xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cpath d=%22M10 10c0-2.21-1.79-4-4-4s-4 1.79-4 4 1.79 4 4 4 4-1.79 4-4z%22 fill=%22%23D4AF37%22/%3E%3C/svg%3E');"></div>
                ...
                <div
                    class="relative z-10 pt-6 flex flex-col sm:flex-row items-start sm:items-center gap-6 border-t border-gray-800 mt-6">
                    <div class="flex flex-col">
                        <span
                            class="text-[10px] uppercase font-bold text-gray-500 tracking-widest">{{__("Libros desde")}}</span>
            ...
            <div class="w-full md:w-1/3 grid grid-cols-2 md:grid-cols-1 gap-4">
                ...
                @foreach($features as $f)
                    <div
                        class="bg-white p-5 rounded-3xl border border-gray-100 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow group">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    @foreach($populares as $libro)
                        <div
                            ...
                            <div
                                class="absolute top-3 left-3 z-20 bg-black text-[#D4AF37] text-[9px] uppercase font-black px-2 py-1 rounded border border-[#D4AF37]/30 shadow-sm">
                                {{__("Top Ventas")}}
                            </div>
