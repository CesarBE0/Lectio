...
<head>
    <meta charset="utf-8">
    <title>Verifica tu cuenta en Lectio</title>
</head>
...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.05);">
    ...
    <tr>
        <td style="padding: 40px 30px; color: #333333; line-height: 1.6;">
            <h2 style="margin-top: 0; font-size: 22px; color: #000000;">¡Hola, {{ $user->name }}!</h2>

            <p style="font-size: 16px; color: #555555; margin-bottom: 30px;">
                Gracias por unirte a <strong>Lectio</strong>. Estás a un solo paso de poder acceder a nuestro catálogo y gestionar tu biblioteca personal. Por motivos de seguridad, necesitamos confirmar que esta dirección de correo es tuya.
            </p>
            ...
            <p style="font-size: 14px; color: #777777; margin-top: 30px; border-top: 1px solid #eeeeee; padding-top: 20px;">
                Si no has creado esta cuenta, no te preocupes, puedes ignorar y eliminar este mensaje con total tranquilidad.
            </p>
        </td>
    </tr>
