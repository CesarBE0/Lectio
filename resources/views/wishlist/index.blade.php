<x-layouts.layout title="Mi Lista de Deseos - Lectio">
    ...
    <div class="container mx-auto px-6 py-12 min-h-[60vh]">
        ...
        <div id="empty-state" class="transition-opacity duration-500 {{ $wishlist->isEmpty() ? 'block' : 'hidden' }} bg-gray-50 rounded-2xl p-12 text-center border border-gray-100">
        ...
        <div id="wishlist-container" class="{{ $wishlist->isEmpty() ? 'hidden' : 'grid' }} grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        ...
                        .then(data => {
                            if(data.success && data.is_wished === false) {
                                ...
                                setTimeout(() => {
                                    ...
                                    const remainingBooks = document.querySelectorAll('.group');
