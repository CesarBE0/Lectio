<footer class="bg-black text-gray-300 pt-16 pb-8 border-t-4 border-[#D4AF37] mt-auto">
    <div class="container mx-auto px-4 md:px-6">

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">

            <div class="space-y-4">
                <h2 class="text-3xl font-serif font-bold text-[#D4AF37] tracking-widest uppercase">Lectio</h2>
                <p class="text-sm text-gray-400 leading-relaxed">
                    Tu refugio literario digital. Descubre miles de historias en formato físico, e-book y audiolibro. Lee, escucha y sueña sin límites.
                </p>
                <div class="flex space-x-4 pt-2">
                    <a href="https://www.facebook.com/cpilosenlaces" class="text-gray-400 hover:text-[#D4AF37] transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
                    </a>
                    <a href="https://www.instagram.com/cpifp_losenlaces" class="text-gray-400 hover:text-[#D4AF37] transition-colors">
            ...
            <div>
                <h3 class="text-white font-bold uppercase tracking-wider text-xs mb-4">Explorar</h3>
            ...
            <div>
                <h3 class="text-white font-bold uppercase tracking-wider text-xs mb-4">Contacto</h3>
                <ul class="space-y-3 text-sm text-gray-400">
                    <li class="flex items-start gap-3">
                        <span class="text-[#D4AF37]">📍</span>
                        <span>CPIFP Los Enlaces<br>Zaragoza, España</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="text-[#D4AF37]">📧</span>
                        <span>bibliotecalectio@gmail.com</span>
                    </li>
                    <li class="flex items-center gap-3">
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 gap-4">
            ...
            <p class="font-medium tracking-wide">Desarrollado con 💻 para el TFG de DAW</p>
        </div>
